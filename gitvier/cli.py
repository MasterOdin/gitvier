...
def _get_command(namespace):
    ...
    def add_kwarg_option(kwargs, namespace):
        kwargs.update(option=namespace.option)

    def add_kwarg_all(kwargs, namespace):
        add_kwarg_force(kwargs, namespace)
        add_kwarg_option(kwargs, namespace)
...
def main():
    ...
    subparsers.add_parser('install', help='', parents=[options])

    subparsers.add_parser('update', help='', parents=[options])

    subparsers.add_parser('list', help='')

    subparsers.add_parser('uninstall', help='', parents=[options])
